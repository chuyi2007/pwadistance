...
public class Block implements Value {
    ...
    private short[][] lengthNoEndGap = null;
     ...
     */
    public void setScore(int[][] score, boolean isTranspose) {
        this.score = score;
	...
	public short[][] getLengthNoEndGap() {
		return lengthNoEndGap;
	}

	public void setLengthNoEndGap(short[][] lengthNoEndGap) {
		this.lengthNoEndGap = lengthNoEndGap;
	}
    ...
    public void fromBytes(byte[] bytes) throws SerializationException {
        ...
        try {
            ...
            if (din.available() > 0) {
                ...
                this.score = new int[rows][cols];
                for (int i = 0; i < rows; i++) {
                    for (int j = 0; j < cols; j++) {
                        this.score[i][j] = din.readInt();
                    }
                }
                ...
                this.lengthNoEndGap = new short[rows][cols];
                for (int i = 0; i < rows; i++) {
                    for (int j = 0; j < cols; j++) {
                        this.lengthNoEndGap[i][j] = din.readShort();
                    }
                }
                ...
                this.distances = new short[rows][cols];
                for (int i = 0; i < rows; i++) {
                    for (int j = 0; j < cols; j++) {
                        this.distances[i][j] = din.readShort();
                    }
                }
            }
            din.close();
