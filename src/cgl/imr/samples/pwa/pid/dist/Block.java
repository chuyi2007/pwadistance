...
public class Block implements Value {
     ...
     */
    public void setDistances(short[][] distances, boolean isTranspose) {
        this.distances = distances;
        this.isTranspose = isTranspose;
        this.rowSize = isTranspose ? distances[0].length : distances.length;
        this.colSize = isTranspose ? distances.length : distances[0].length;
    }
