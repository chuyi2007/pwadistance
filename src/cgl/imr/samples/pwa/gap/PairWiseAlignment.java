...
public class PairWiseAlignment {
	...
	public static double drivePWAMapReduce(int numOfMapTasks, int numOfReduceTasks,
			...
			String geneBlockPrefix, String outputPrefix, String outputFile, String type, String matrixType)
	throws TwisterException {
		...
		try {
			...
			if (!combiner.getResults().isEmpty()) {
				...
				finalValue = ((DoubleValue) combiner.getResults().get(key)).getVal();
	...
	public static void main(String args[]) {
		...
		try {
			sequentialTime = drivePWAMapReduce(numOfMapTasks, numOfReduceTasks, numOfSeqs,
					numOfPartitions, dataDir, geneBlockPrefix, outputPrefix, outputFile, type, matrixType);
